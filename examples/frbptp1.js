...
// t = new Tree({keyhandler: kh, valuehandler: vh, block_size: 16384, path: '/tmp/rtest.dat'});
t = new Tree({keyhandler: kh, valuehandler: vh, block_size: 128, path: '/tmp/rtest.dat'});
